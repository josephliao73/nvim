...
mason_lspconfig.setup_handlers({
  function(server)
    local opts = { on_attach = M.on_attach, capabilities = M.capabilities }
  ...
  ["rust_analyzer"] = function()
    ...
    ["clangd"] = function()
    local caps = vim.tbl_deep_extend("force", M.capabilities, { offsetEncoding = { "utf-16" } })
...
return {
    -- lspconfig
    {
        ...
        {'mrcjkb/haskell-tools.nvim', version = '^6'},
    }
